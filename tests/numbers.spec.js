...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it('Verifica se a função `numbers` retona `true` quando a função receber [1, 2, 3, 4, 5]', () => {
    expect(numbers([1, 2, 3, 4, 5])).toEqual(true);
  });
  // Escreva um teste em que a função recebe [1, 2, '3', 4, 5] e retorna false
  it('Verifica se função `numbers` retorna `false` quando a função receber [1, 2, "3", 4, 5]', () => {
    expect(numbers([1, 2, '3', 4, 5])).toEqual(false);
  });
  // Escreva um teste em que a função recebe [1, 'a', 3] e retorna false
  it('Verifica se função `numbers` retorna `false` quando a função receber [1, "a", 3]', () => {
    expect(numbers([1, 'a', 3])).toEqual(false);
  });
  // Escreva um teste em que a função recebe [' '] e retorna false
  it('Verifica se função `numbers` retorna `false` quando a função receber [" "]', () => {
